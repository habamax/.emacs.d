...
(deftheme nocharm-light
  "Minimal low contrast light Emacs theme.")
...
(let* ((classTTY '((type tty)))
       ...
       (grey1 "#c7c7c7")(grey2 "#e4e4e4")
       (non-text "#878787")
       (match-paren "#ff00af")(match "#e0c7e0")
       (mode-line-active "#bababa")(mode-line-inactive "#c0c0c0")
       (menu "#eeeeee")
       (header-line "#cacaca")
       (hl-line "#e2e2e2")
  ...
  (custom-theme-set-faces
   ...
   ;; diff
   `(diff-header
     ((t (:background ,grey1 :foreground ,black :weight bold))))
   `(diff-file-header
