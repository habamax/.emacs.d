;;; nocharm-light-theme.el --- no charm light theme -*- lexical-binding: t; -*-
...
;; Light Emacs theme with less syntax highlighting.


;;; Code:

(deftheme nocharm-light "No charm light Emacs theme.")
